...
class ListaAtomica {
 ...
 public:
    ...
    void insertar(const T &valor) {
        ...
        Nodo *viejo = _cabeza.load();
        nuevo->_siguiente = viejo;
        while (!_cabeza.compare_exchange_weak(viejo, nuevo))
        {
            // Si la comparación da false, viejo = cabeza.load(), si da true, cabeza = nuevo
            nuevo->_siguiente = viejo;
        }
